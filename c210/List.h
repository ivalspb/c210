...
class List
{
	...
	//сортировка сли€нием с использованием ссылки на функцию сравнени€
	List* mergersort(List* list, bool(List::* p_greater_func)(Node* node1, Node* node2));
	//вспомогательна€ функци€ сли€ни€ с упор€дочиванием с использованием ссылки на функцию сравнени€
